...
def overall_event(df):
    ...
    fig = px.scatter(avgs, x='telePoints', y='autoPoints',
             hover_data=['teamName', 'telePoints', 'autoPoints', 'chargePoints', 'defenseScore'], size='chargePoints',
             labels={'telePoints':'teleop points', 'autoPoints': "auto points", 'chargePoints': 'charge station points', 'teamName': "team name", 'defenseScore': "defense"}, color="defenseScore", color_continuous_scale=px.colors.sequential.Plotly3)
    ...
    fig.update_layout(
        title={'text': "Eventwide performance by team",
               ...
               'x': 0.5,
                'xanchor': 'center',
                'yanchor': 'top'},  
        width=1500, height=700, paper_bgcolor='rgba(255,255,255,0)',
